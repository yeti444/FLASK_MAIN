...
-- Started on 2024-10-05 19:42:57
...
--
-- TOC entry 4928 (class 0 OID 16385)
-- Dependencies: 217
-- Data for Name: maintanedresources; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.maintanedresources (maintid, resourceid) FROM stdin;
1	1
2	1
3	1
\.
...
--
-- TOC entry 4951 (class 0 OID 16505)
-- Dependencies: 240
-- Data for Name: maintenancetype; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.maintenancetype (maintenancetypeid, typename) FROM stdin;
1	Common
\.
...
COPY public.resources (resourceid, name, typeid, info, "createdDate") FROM stdin;
1	test	1	{"x":100, "y":300, "z":400}	2024-09-20 14:48:39.738442+02
\.


--
-- TOC entry 4934 (class 0 OID 16398)
-- Dependencies: 223
-- Data for Name: resourcetypes; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.resourcetypes (typeid, typename) FROM stdin;
6	3d nyomtato 2
7	3d nyomtato 3
8	3d nyomtato 4
9	3d nyomtato 5
...
--
-- TOC entry 4936 (class 0 OID 16404)
-- Dependencies: 225
-- Data for Name: scheduledmaintenance; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.scheduledmaintenance (maintid, userid, fromdate, duration, createdate, description, maintenancetypeid) FROM stdin;
1	1	2024-10-08 00:00:00+02	24:00:00	2024-10-05 14:26:13.057084+02	Test	1
2	1	2025-01-01 00:00:00+01	24:00:00	2024-10-05 14:53:01.934511+02	test	1
3	1	2025-01-01 00:00:00+01	24:00:00	2024-10-05 14:53:15.065872+02	test	1
\.


--
-- TOC entry 4939 (class 0 OID 16410)
-- Dependencies: 228
-- Data for Name: scheduledresources; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.scheduledresources (workid, resourceid) FROM stdin;
1	1
2	1
\.
...
--
-- TOC entry 4942 (class 0 OID 16415)
-- Dependencies: 231
-- Data for Name: scheduledwork; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.scheduledwork (workid, userid, fromdate, duration, createdate) FROM stdin;
1	1	2024-10-05 00:00:00+02	24:00:00	2024-10-05 13:38:09.936184+02
2	1	2024-11-01 00:00:00+01	00:24:00	2024-10-05 14:04:21.265003+02
3	1	2024-12-01 00:00:00+01	24:00:00	2024-10-05 14:05:27.283368+02
\.


--
-- TOC entry 4945 (class 0 OID 16421)
-- Dependencies: 234
-- Data for Name: userdata; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.userdata (userid, email, firstname, lastname, password, createdate, roleid) FROM stdin;
1	kristof20011020@gmail.com	Kristof Mark	Jakab	password	2024-09-20 13:04:21.761875+02	1
4	yeti4441@gmail.com	Random	Random	password	2024-10-03 10:29:52.586565+02	1
9	vincekiss1414@gmail.com	Kiss	Vince	\\x243262243132243050516f395439704b364b65584c77494b6a425a6165786566522e505167467834654e5a617734732f63336e326971616236754657	2024-10-05 19:29:17.481601+02	1
\.
...
SELECT pg_catalog.setval('public.scheduledmaintenance_maintid_seq', 3, true);
...
SELECT pg_catalog.setval('public.scheduledwork_workid_seq', 3, true);
...
SELECT pg_catalog.setval('public.userdata_userid_seq', 9, true);
...
--
-- TOC entry 4773 (class 2606 OID 16512)
...
--
-- TOC entry 4761 (class 2606 OID 16450)
...
--
-- TOC entry 4763 (class 2606 OID 16452)
...
--
-- TOC entry 4765 (class 2606 OID 16454)
...
--
-- TOC entry 4767 (class 2606 OID 16456)
...
--
-- TOC entry 4771 (class 2606 OID 16460)
...
--
-- TOC entry 4775 (class 2606 OID 16466)
...
--
-- TOC entry 4779 (class 2606 OID 16481)
...
--
-- TOC entry 4780 (class 2606 OID 16486)
...
-- Completed on 2024-10-05 19:42:57
